...
import { voluntaryWork } from "../../../util/DataTemplate";
...
import { getUserByID, pushVoluntaryWorkInfo } from "../../../util/Database";

const VoluntaryWork = (props) => {
    const [formData, setFormData] = useState({...voluntaryWork});
    ...
    useEffect(()=>{
        const fetchData = async () => {
            ...
            if(response.isSuccess){
                let data = response.data.voluntaryWork.data;
   ...
   const save = async () => {
    ...
    try {
        await pushVoluntaryWorkInfo({data: formData}, props.userID);
        setSystemOPeration(null);
        ...
        <Fragment>
            <div style={{width: '98%', height: '100%'}}>
                <table>
                    <thead>
                        <tr>
                            <th>Work Experience or Involvement in Civil / Non-Government / People / Voluntary Organization</th>
                        </tr>
                    </thead>
                </table>
                    ...
                    <div className="dialog_prompt">
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                        <TextfieldFragment disable={props.viewMode} type='text' name='Name &  Address of Organization' varName='nameAndAddress' value={newData.nameAndAddress} onChange={(e)=> {handleNewDataChange(e)}} placeholder='(Write in Full)'/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <TextfieldFragment disable={props.viewMode} type='text' name='Position/Nature of Work' varName='position' value={newData.position} onChange={(e)=> {handleNewDataChange(e)}}/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div className="dialog_div" style={{position: 'fixed'}}>
                    ...
                    <table>
                            <tbody>
                                <tr>
                                    <td>
                                        <TextfieldFragment disable={props.viewMode} type='text' name='Name &  Address of Organization' varName='nameAndAddress' value={editData.data.nameAndAddress} onChange={(e)=> {handleEditDataChange(e)}} placeholder='(Write in Full)'/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <TextfieldFragment disable={props.viewMode} type='text' name='Position/Nature of Work' varName='position' value={editData.data.position} onChange={(e)=> {handleEditDataChange(e)}}/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
