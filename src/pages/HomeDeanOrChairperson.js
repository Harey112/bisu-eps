...
const HomeDeanOrChairperson = ({selected, view}) => {
    const tabs = [
        { name: "Dashboard", component: Dashboard, id: "dashboard", message: '', data: '', key: 1, priority: 1 },
        { name: "Faculty", component: Department, id: "department", message: 'Go To Faculty', data: '', key: 2, priority: 0 },
...
export default HomeDeanOrChairperson;